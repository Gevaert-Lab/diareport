...
#source('utils_function.R')
 ...
 required_packages = required_packages = c('QFeatures',"ggrepel","tidyr",
                       ...
                       ,"UpSetR",'logger','pander','heatmaply','GGally','yaml','webshot2','htmlwidgets','htmlwidgets')
...
log_info('Running Analysis for each comparison..')
  ...
  for (cmp in names(res_de)) {
    ...
    cat('\n\n')
    cat('\n\n')
    cat('These bar plots summarize the number of significantly upregulated/downregulated  precursors based on different adjusted p-values (selected adjusted p-values are 0.001, 0.01, 0.05, and 0.1 - see facet headers) and log2 fold-change thresholds (on the x-axis) used to define the significance levels.')
