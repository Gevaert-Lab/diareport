...
In this section, the protein intensities of 8 EV marker proteins (CD9, CD63, SDCBP, CD8, TSG101, PDCD6IP, FLOT1, GAG-EGFP) are summarized for all groups. The large dot represents the mean of the sample intensities for each protein, and the length of the bar corresponds to the interval $\mu \pm \sigma$.
...
f <- assay(pe[['proteinRS']])[marker$Accession  , ] %>% as.data.frame() %>% 
