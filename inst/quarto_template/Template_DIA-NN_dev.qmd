...
The table shows a summarry of the number of DE proteins found in all comparisons. The overlap of DE proteins among the comparisons is also showed using an upset plot.
