...
In the table you can find a summaries of the number of DE precursors found in all the comparisons. The overlapping of DE precursors among the comparisons is also showed using an upset plot.
